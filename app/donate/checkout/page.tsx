...
export default function ParticipationPortalPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!agreed) return setError("Please confirm your understanding of this voluntary resource exchange.")
    if (!email) return setError("Please provide an email so we can send your stewardship receipt.")
    if (amount <= 0) return setError("Please select a positive resource amount.")

    setIsSubmitting(true)

    try {
      // Redirect with amount included
                ...
                <div className="glass-card rounded-2xl p-6 sm:p-8 space-y-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <input
                      ...
                      className="w-full h-2 bg-muted rounded-lg cursor-pointer mt-2"
                    />
                ...
                <div className="glass-card rounded-2xl p-6 sm:p-8 space-y-6">
                  ...
                  <div className="space-y-3 text-xs text-muted-foreground border-t border-border/60 pt-4">
                    <p>
                      ...
                      This resource exchange is voluntary and used exclusively for  
          ...
          <aside className="space-y-6 lg:sticky lg:top-24">
            <div className="glass-card rounded-2xl p-6 space-y-5 border border-primary/20">
              ...
              <div className="space-y-3">
                <ImpactMetric
                  ...
                  value={impact.trees}
                  description="Layers across emerging syntropic forest systems."
                />
                <ImpactMetric
                  label="Regenerative Cells Strengthened"
                  value={impact.acres}
                  description="Micro-landscape systems integrating hydration cycles."
                />
                <ImpactMetric
                ...
                {impact.research_plots > 0 && (
                  <ImpactMetric
                    ...
                    description="Ecological & BPSS research initiatives."
                  />
                )}
              </div>
            </div>
            ...
            <div className="glass-card rounded-2xl p-5 space-y-3 text-xs text-muted-foreground">
              ...
              <ul className="list-disc list-inside space-y-1">
                <li>Watershed & regenerative design</li>
                <li>Open scientific research</li>
