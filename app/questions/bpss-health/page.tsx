      ...
      >
        <div className="max-w-3xl space-y-4">
          ...
          >
            ...
            <p>
              At first, water drips onto the floor. You slip. You panic. It feels
              urgent.
            </p>
            <p>So you act.</p>
            <p>
              You wipe the floor every morning. You place a bucket under the
              drip. On bad days, you carry an umbrella inside the house.
            </p>
            <p>
              Each solution helps. The floor stays dry. Life becomes manageable
              again.
            </p>
            <p>From the outside, it looks solved.</p>
            <p>
              But every time it rains, your body tightens. You listen for the
              drip. You plan your life around it.
            </p>
            <p className="font-medium">
              Healing doesn’t feel like better buckets. Healing feels like the
              roof being fixed.
            </p>
          </Details>
          ...
          >
            ...
            <p>
              This way of thinking comes from an education system designed for
              efficiency and specialization.
            </p>
            <p>
              Each person is trained to fix a part. No one is responsible for the
              whole.
            </p>
            <p>
              Looking up at the roof isn’t assigned to anyone. So it never
              happens.
            </p>
          </Details>
          ...
          >
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Mopping the floor</strong> → painkillers,
                anti-inflammatories
              </li>
              <li>
                <strong>Placing buckets</strong> → blood-pressure drugs,
                antiplatelets, cholesterol medications
              </li>
              <li>
                <strong>Sweeping water away</strong> → sugar control, acid
                suppression, organ-protective drugs
              </li>
              <li>
                <strong>Holding an umbrella</strong> → antidepressants,
          ...
          >
            ...
            <p>
              The body isn’t broken. It’s responding correctly to an unresolved
              problem.
            </p>
          </Details>
          ...
          >
            <ul className="list-disc pl-6">
              <li>
                <strong>Biological</strong> — body and physiology
              </li>
              <li>
                <strong>Psychological</strong> — mind and emotions
              </li>
              <li>
                <strong>Social</strong> — environment and relationships
              </li>
              <li>
                <strong>Spiritual</strong> — meaning, purpose, values
              </li>
            </ul>
          </Details>
          ...
          >
            ...
            >
              ...
              <p>
                Medicine is excellent at limiting damage once stress breaks
                through.
              </p>
            ...
            >
              <p>
                Chronic stress, fear, unresolved grief, and pressure bend the
                system over time.
              </p>
              <p>
                When this load never lifts, symptoms return — even with
                treatment.
              </p>
            </SubDetails>
            ...
            >
              <p>
                Unsafe work, isolation, instability, and lack of rest are like
                constant storms.
              </p>
          ...
          {/* ======== ZENTRUST SUB-QUESTION (ADDED) ======== */}
          <Details
            title="Why does ZenTrust approach healing differently?"
            answer="Because ZenTrust is structured to look at the roof, not just manage the water."
          >
            <p>
              ZenTrust does not organize care around symptom suppression or short
              feedback loops.
            </p>
            <p>
              It examines how biological strain, psychological load, social
              pressure, and meaning interact over time.
            </p>
            <p className="font-medium">
              Inside systems optimized for quick relief, this can look slow. It
              is not.
            </p>
          </Details>
