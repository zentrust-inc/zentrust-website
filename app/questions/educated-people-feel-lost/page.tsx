      ...
      sections={[
        {
          ...
          children: (
            <>
              Many people reach milestones that were presented as proof of arrival.
              Degrees are earned, careers established, routines stabilized. On the
              outside, things appear settled. Inside, something feels unfinished.
              The education system focused on outputs that could be measured and
              rewarded. It rarely addressed how a person relates to their own
              desires or doubts. When the external path ends, there is no inner
              reference point to continue from.
            </>
          ),
        },
        {
          ...
          children: (
            <>
              Education rewards accuracy and correctness within predefined
              boundaries. Intelligence becomes the ability to operate well inside
              those boundaries. When life presents questions without grading or
              clear criteria, that intelligence feels disoriented. The mind keeps
              searching for the correct move, assuming one exists. The difficulty
              is not lack of capacity, but the absence of a frame chosen by the
              person themselves.
            </>
          ),
        },
        {
          ...
          children: (
            <>
              Modern education developed alongside systems that required
              predictable behavior. Schools emphasized punctuality, repetition,
              and following directions. These skills help systems function
              smoothly. Less attention was given to self-inquiry or inner
              navigation. Students learned how to fit into roles that already
              existed, rarely examining whether those roles aligned with who they
              were becoming.
            </>
          ),
        },
        {
          ...
          children: (
            <>
              Many adults feel calm when expectations are defined and roles are
              clear. Titles and schedules provide orientation. When those
              structures weaken through career or personal changes, uncertainty
              grows. Decisions feel heavy and rest feels undeserved. Without
              external reference points, people struggle to trust their own sense
              of direction.
            </>
          ),
        },
        {
          ...
          children: (
            <>
              Early curiosity often wandered beyond assigned topics. Over time,
              questions were timed or redirected. Students learned which
              curiosities were safe and which caused friction. Exploration slowly
              gave way to strategy. Curiosity did not disappear, but it learned to
              stay quiet.
            </>
          ),
        },
        {
          ...
          children: (
            <>
              Parents and institutions often pass on what brought stability. When
              a system appears to work, questioning it feels risky. The rewards of
              conformity are visible and immediate. The costs are subtle and
              delayed. As a result, the same structures are reproduced.
            </>
          ),
        },
        {
          ...
          children: (
            <>
              ZenTrust questions do not assume something inside you is broken.
              When education presents itself as complete and neutral, confusion
              has nowhere external to land. It turns inward. Uncertainty becomes
              interpreted as inadequacy. This appearance reflects training that
              never included self-orientation.
            </>
          ),
        },
        {
          ...
          children: (
            <>
              Noticing conditioning does not provide instant clarity. It creates
              space. The need to perform softens. Questions are allowed to remain
              open. Learning shifts from achievement to understanding. Something
              personal begins to grow where obedience once provided direction.
            </>
          ),
        },
      ]}
