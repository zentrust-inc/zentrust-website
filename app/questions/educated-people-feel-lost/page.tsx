      ...
      sections={[
        {
          ...
          eli15:
            "Many people reach milestones that were presented as proof of arrival. Degrees are earned, careers established, routines stabilized. On the outside, things appear settled. Inside, however, something feels unfinished. The education system focused on outputs that could be measured, graded, and rewarded. It rarely addressed how a person relates to their own desires or doubts. When the external path ends, there is no inner reference point to continue from.",
          metaphor:
        ...
        },
        {
          ...
          expandAffordance: "Expand for the fuller picture",
          eli15:
            "Education rewards accuracy, speed, and correctness within predefined boundaries. Intelligence becomes the ability to operate well inside those boundaries. When life presents questions without instructions, grading, or clear criteria, that intelligence feels disoriented. The mind keeps searching for the correct move, assuming one exists. The difficulty is not lack of capacity, but the absence of a frame chosen by the person themselves.",
          metaphor:
        ...
        },
        {
          ...
          expandAffordance: "Expand for the fuller picture",
          eli15:
            "Modern education developed alongside industrial and administrative systems that required predictable behavior. Schools emphasized punctuality, repetition, and following directions. These skills help systems function smoothly. Less attention was given to self-inquiry, value formation, or inner navigation. Students learned how to fit into roles that already existed. Rarely were they invited to examine whether those roles aligned with who they were becoming as individuals.",
          metaphor:
        ...
        },
        {
          ...
          expandAffordance: "Expand for the fuller picture",
          eli15:
            "Many adults feel calm when expectations are defined and roles are clear. Titles, schedules, and evaluations provide orientation. When those structures weaken, through career shifts or personal changes, uncertainty grows. Decisions feel heavy and rest feels undeserved. Without external reference points, people struggle to trust their own sense of direction. This discomfort reflects missing inner orientation rather than personal weakness.",
          metaphor:
        ...
        },
        {
          ...
          expandAffordance: "Expand for the fuller picture",
          eli15:
            "Early curiosity often wandered beyond assigned topics. Over time, questions were timed, graded, or redirected. Students learned which curiosities were safe and which caused friction. Exploration slowly gave way to strategy. Curiosity did not disappear, but it learned to stay quiet. As adults, many people still feel the urge to explore, yet associate it with inefficiency or danger rather than discovery.",
          metaphor:
        ...
        },
        {
          ...
          expandAffordance: "Expand for the fuller picture",
          eli15:
            "Parents and institutions often pass on what brought stability. When a system appears to work, questioning it feels risky. The rewards of conformity are visible and immediate. The costs are subtle and delayed. As a result, the same structures are reproduced. Each generation is prepared to succeed within existing frameworks, while the deeper effects on inner life remain unexamined.",
          metaphor:
        ...
        },
        {
          ...
          expandAffordance: "Expand for the fuller picture",
          eli15:
            "ZenTrust questions do not assume something inside you is broken. They ask why certain feelings reliably emerge under certain conditions. When education presents itself as complete and neutral, confusion has nowhere external to land. It turns inward. Uncertainty becomes interpreted as inadequacy. From a ZenTrust perspective, this appearance reflects training that never included self-orientation, not evidence of individual failure.",
          metaphor:
        ...
        },
        {
          ...
          expandAffordance: "Expand for the fuller picture",
          eli15:
            "Noticing conditioning does not provide instant clarity. It creates space. The need to perform softens. Questions are allowed to remain open. Learning shifts from achievement to understanding. This change is subtle and often invisible. It does not reject education, but recognizes its limits. Something personal and alive begins to grow where obedience once provided direction.",
          metaphor:
